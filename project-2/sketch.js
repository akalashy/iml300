// Astghik Kalashyan
// IML 300 - Drawing Tool
//My drawing tools are rectangles that can be applied by making a click with a mouse, as well as adding many rectangles when the mouse remains pressed, English letters that can then be added anywhere on the Canvas page by pressing the letters on the keyboard, and lines by pressing 0. The program is coded to create a crossword puzzle with rectangles and English letters from A to Z. The idea was inspired by my grandfather, who called me to ask for a few words while he was filling out his crossword in a newspaper. The rectangles have strokes to display their outlines, and they appear in random tones of grey. Each of the English letters has its color. The user should place the mouse wherever they want to write the letter and press the letter on the keyboard. To draw one piece of the same letter, the user should press any number on the keyboard from 1 to 9; otherwise, the letter will continue appearing on the Canvas with the movement of the mouse, since it is designed as a brush. The lines work as a brush too, starting from the bottom-right of the Canvas. By pressing 0 and moving the mouse over the page, the rectangles will appear on the edges of the lines. They can be used for creating more spaces for letters and ideas. Overall, besides the intended purpose of the drawing tools, they can be used as brushes for drawings for aesthetic purposes.
